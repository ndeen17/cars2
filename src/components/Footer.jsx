          ...
          {subscribed ? (
            ...
            <div style={s.newsletter}>
              <input
                ...
                style={s.nlInput}
              />
              <button onClick={handleSubscribe} style={s.nlBtn}>→</button>
            </div>
          )}
        </div>
      </div>

      <div className="footer-bottom-wrap" style={s.bottom}>
...
const s = {
  ...
  links:      { display: 'flex', flexDirection: 'column', gap: 10, fontSize: 14 },
  link:       { color: '#6c6c74' },
  ...
  nlBtn:      { background: '#18181c', color: '#f5f4f1', fontWeight: 700, fontSize: 16, width: 44, height: 44, border: 'none', borderRadius: '50%', cursor: 'pointer', fontFamily: 'inherit', flexShrink: 0 },
