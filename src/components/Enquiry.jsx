...
export default function Enquiry({ selectedModel, onModelChange }) {
  ...
  return (
    <section id="enquiry" className="enquiry-section-pad" style={s.section}>
      <div className="enquiry-inner">

        {/* left copy */}
        <div>
          <div style={s.mono}>Enquiry</div>
          <h2 className="enquiry-heading" style={s.heading}>Ready for a closer look?</h2>
          <p style={s.sub}>
...
function Field({ label, children }) {
  return <label className="form-col">{label}{children}</label>
}
