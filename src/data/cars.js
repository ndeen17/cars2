export const CARS = [
  ...
  { id: 'terra',  name: 'Terra X',   body: 'SUV',       type: 'Hybrid',   tags: ['Hybrid', 'SUV'],      price: '$51,000',  transmission: 'Auto / Manual', seats: 5, bags: 3, rating: '4.6', asset: '/assets/terra-x.mp4' },
  { id: 'ion',    name: 'Ion',       body: 'Hatchback', type: 'Electric', tags: ['Electric'],           price: '$34,000',  transmission: 'Automatic',     seats: 5, bags: 1, rating: '4.5', asset: '/assets/ion.mp4' },
  ...
  { id: 'drift',  name: 'Drift R',   body: 'Coupe',     type: 'Petrol',   tags: ['Sport'],              price: '$76,000',  transmission: 'Manual',        seats: 2, bags: 1, rating: '4.7', asset: '/assets/drift-r.mp4' },
]
